...
drop table player if exists player;
drop table team if exists team; 
drop table STADIUM if exists STADIUM; 
drop table SCHEDULE if exists SCHEDULE;
...
(
  ...
  TEAM_NAME nvarchar(40)  NOT NULL,
  E_TEAM_NAME nvarchar(50),
  ORIG_YYYY CHAR(4),
...
STADIUM_ID    CHAR(3) NOT NULL,
STADIUM_NAME  nvarchar(40) NOT NULL,
HOMETEAM_ID   CHAR(3),
SEAT_COUNT    int,
ADDRESS       nvarchar(60),
DDD           nvarchar(3),
